...
* Explanation
  ...
  Included are two CPU implemenations of this, one using Gaussian Elimination ([[./simulate/include/solve/basic_gaussian.hpp]]) and one using LU decomposition ([[https://en.wikipedia.org/wiki/LU_decomposition#Using_Gaussian_elimination]]) ([[./simulate/include/solve/gaussian_lu.hpp]]).
  There is also in implemenation of LU decomposition using SYCL ([[./simulate/include/solve/sycl_gaussian_lu.hpp]]) which I think will be of most interest.

  I have also included some notes on some basic performance work I did for the SYCL implemenation.
...
*** In-Order Queue
    ...
    Since in-order queue isn't directly portable to ComputeCpp, I will leave this out of my implemenation.
